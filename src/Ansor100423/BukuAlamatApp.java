...
public class BukuAlamatApp {
    public static void main(String[] args) {
        ...
        EntryBukuAlamat DeathNote;
        EntryBukuAlamat[] saya = new EntryBukuAlamat[100];
        
        boolean berjalan = true;
        while (berjalan) {
            DeathNote = new EntryBukuAlamat();
            System.out.println("=======================");
            ...
            switch (pilihan) {
                case 1:
                        ...
                        DeathNote.setNama(nama);DeathNote.setAlamat(alamat);DeathNote.setNomorTelepon(nomorTelepon);DeathNote.setAlamatEmail(alamatEmail);
                        saya[i++]= DeathNote;
                ...
                case 2:
                    ...
                    in.nextLine();
                    DeathNote.setNama("");DeathNote.setAlamat("");DeathNote.setNomorTelepon("");DeathNote.setAlamatEmail("");
                    saya[i]= DeathNote;
                    System.out.println("Data berhasil ditambahkan :-)");
                    System.out.println("\n");
                    break;
